...
public partial class UTCarreersContext : DbContext
{
    public UTCarreersContext()
    {
    }

    public UTCarreersContext(DbContextOptions<UTCarreersContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Applicant>(entity =>
        {
            ...
            entity.HasIndex(e => e.JobId, "applicants_job_id_foreign");
            ...
            entity.HasOne(d => d.Job).WithMany(p => p.Applicants)
                ...
                .HasConstraintName("applicants_job_id_foreign");
        ...
        modelBuilder.Entity<JobCategory>(entity =>
        {
            ...
            entity.HasMany(d => d.JobPosts).WithMany(p => p.JobCategories)
                .UsingEntity<Dictionary<string, object>>(
                    "JobCategoriesJobPost",
                    r => r.HasOne<JobPost>().WithMany()
                        .HasForeignKey("JobPostId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("job_categories_job_posts_job_post_id_foreign"),
                    l => l.HasOne<JobCategory>().WithMany()
                        .HasForeignKey("JobCategoryId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("job_categories_job_posts_job_category_id_foreign"),
                    j =>
                    {
                        j.HasKey("JobCategoryId", "JobPostId")
                            .HasName("PRIMARY")
                            .HasAnnotation("MySql:IndexPrefixLength", new[] { 0, 0 });
                        j
                            .ToTable("job_categories_job_posts")
                            .UseCollation("utf8mb4_unicode_ci");
                        j.HasIndex(new[] { "JobPostId" }, "job_categories_job_posts_job_post_id_foreign");
                        j.IndexerProperty<Guid>("JobCategoryId").HasColumnName("job_category_id");
                        j.IndexerProperty<Guid>("JobPostId").HasColumnName("job_post_id");
                    });
        });
        ...
        modelBuilder.Entity<Selection>(entity =>
        {
            ...
            entity.HasIndex(e => e.JobId, "selections_job_id_foreign");
            ...
            entity.HasOne(d => d.Job).WithMany(p => p.Selections)
                .HasForeignKey(d => d.JobId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("selections_job_id_foreign");
        });
